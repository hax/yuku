...
pub const Lexer = struct {
    ...
    const keyword_list = [_]struct { []const u8, TokenTag }{
        ...
        .{ "export", .@"export" },      .{ "global", .global },           .{ "import", .import },
        .{ "module", .module },         .{ "number", .number },           .{ "object", .object },
        .{ "public", .public },         .{ "return", .@"return" },        .{ "string", .string },
        .{ "symbol", .symbol },         .{ "switch", .@"switch" },        .{ "static", .static },
        .{ "source", .source },         .{ "typeof", .typeof },           .{ "unique", .unique },
        .{ "asserts", .asserts },       .{ "boolean", .boolean },         .{ "default", .default },
        .{ "declare", .declare },       .{ "extends", .extends },         .{ "finally", .finally },
        .{ "private", .private },       .{ "package", .package },         .{ "require", .require },
        .{ "unknown", .unknown },       .{ "accessor", .accessor },       .{ "abstract", .abstract },
        .{ "continue", .@"continue" },  .{ "debugger", .debugger },       .{ "function", .function },
        .{ "override", .override },     .{ "readonly", .readonly },       .{ "interface", .interface },
        .{ "intrinsic", .intrinsic },   .{ "namespace", .namespace },     .{ "protected", .protected },
        .{ "satisfies", .satisfies },   .{ "undefined", .undefined },     .{ "instanceof", .instanceof },
